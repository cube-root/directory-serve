        ...
        files.forEach((file) => {
          ...
          if (fs.lstatSync(filePath).isFile()) {
            htmlResponse +=
              ...
              "</a>" +
              "<div>" +
              `<a target="_blank" class="text-blue-600 text-sm px-2 py-1 bg-blue-100 rounded-full" href=${file}>` +
              "Download" +
              "</a>" +
              "</div>" +
              "</li>";
            ...
            htmlResponse +=
              ...
              "</svg>" +
              '<a class="text-blue-600 text-sm px-2 py-1 bg-blue-100 rounded-full" href="' +
              appendSlash(req.url) +
              file +
              "/" +
              '">' +
